...
\node [bluebox, rounded corners=2pt] (deepthought-label) at (deepthought.north) {\textbf{github.com}};
...
% Pull
\draw[pull]  (tn01.west) .. controls +(-2,2) and +(-1,-3) .. node[pull-label]{pull} (blessed-repo.west);
\draw[pull]  (tn02.172) .. controls +(-2,0) and +(0,-3) .. node[pull-label]{pull} (blessed-repo.south);
\draw[pull]  (tn02.west) .. controls +(-3,-1) and +(3,-4) .. node[pull-label]{pull} (tn01-repo.-35);
